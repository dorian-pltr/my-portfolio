...
export type GetProjectsQuery = { __typename?: 'Query', project: Array<{ __typename?: 'Project', id: string, name: string, description: string, startDate: any, endDate?: any | null, url?: string | null, status: { __typename?: 'ProjectStatus', id: string, name: string }, technologies: Array<{ __typename?: 'Technology', id: string, name: string, isMain: boolean, type: { __typename?: 'TechnologyType', id: string, name: string } }>, images: Array<{ __typename?: 'Image', id: string, url: string, isMain: boolean }> }> };
